...
Throughout this walkthrough, we will use the Fortran [exercises] defined within this repo.

### Codespaces

The exercises repository is setup to work via GitHub codespaces. This process is documented in the **exercises/README.md**.
